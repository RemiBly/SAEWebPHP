            ...
            <main>
                ...
                <?php else : ?>
                    <?php foreach ($dataAlbum as $album) : ?>
                        <a href="./detail-album.php" class="album album__css" data-year="<?= strtolower($album['releaseYear']) ?>" data-title="<?= strtolower($album['title']) ?>" data-artist="<?= strtolower($album['by']) ?>">
